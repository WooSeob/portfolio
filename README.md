...
개발을 좋아하며 클린코드 & 아키텍쳐 장인의 꿈이 있는 예비 주니어 개발자 변우섭 입니다.
...
1. 개요
   ...
   - '[캐치마인드](https://cmind.netmarble.net/main.asp)'라는 게임을 node.js 백엔드와 Angular프론트엔드, socket.io를 통해서 웹 버전으로 구현했습니다. 웹서버 프레임워크는 Express를 사용했으며 데이터베이스는 mongoDB를, ODM은 mongoose를 사용했습니다. 객체지향적 특징을 더 잘 활용할 수 있도록 백엔드 또한 TypeScript로 구현했습니다. 
...
3. 개선중인 작업
   ...
   - 테스트 코드 작성
     ...
     - 따라서 단위 테스트 코드와 end to end 테스트 코드 작성을 통해 위 문제들을 해결해보려 합니다.
